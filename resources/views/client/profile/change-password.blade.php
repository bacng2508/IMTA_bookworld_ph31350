                            ...
                            <div class="tab-content" id="myaccountContent">
                                ...
                                <div class="tab-pane fade show active" id="dashboad" role="tabpanel">
                                    <div class="myaccount-content">
                                        ...
                                        <form action="">
                                            <div class="row">
                                                <div class="col-5 px-4 justify-self-center">
                                                    <div class="text-center">
                                                        <img src="{{ Storage::url(Auth::user()->avatar) }}" alt="" width="200px">
                                                    </div>
                                                ...
                                                <div class="col-7 border-start">
                                                    <div class="">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="mb-0 form-control" type="text" name="password"
                                                                id="password" placeholder="Nhập email">
                                                            @error('password')
                                                                <div class="form-text text-danger">{{ $message }}
                                                                </div>
                                                            @enderror
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="password" class="fw-bold">Số điện thoại</label>
                                                            <input class="mb-0 form-control" type="text" name=""
                                                                id="password" placeholder="Nhập email">
                                                            @error('password')
                                                                <div class="form-text text-danger">{{ $message }}
                                                                </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="password" class="fw-bold">Địa chỉ</label>
                                                            <input class="mb-0 form-control" type="text" name=""
                                                                id="password" placeholder="Nhập email">
                                                            @error('password')
                                                                <div class="form-text text-danger">{{ $message }}
                                                    ...
                                                    <div class="">
                                                        <button type="submit"
                                                            class="btn btn-outlined w-100 bg__main-color text-white">Cập nhật</button>
                                                    </div>
                                                </div>
                                            </div>
