...
@section('page-content')
                ...
                <div class="container">
                    <div class="home-content text-center text-sm-left position-relative">
                        <div class="hero-partial-image image-right">
                            <img src="{{ asset('client/assets') }}/image/bg-images/home-slider-2-ai.png" alt="">
                        </div>
                        <div class="row g-0">
                ...
                <div class="container">
                    <div class="home-content text-center text-sm-left position-relative">
                        <div class="hero-partial-image image-left">
                            <img src="{{ asset('client/assets') }}/image/bg-images/home-slider-1-ai.png" alt="">
                        </div>
            ...
            <div class="row space-db--30">
                <div class="col-lg-6 col-md-6 mb--30">
                    <a href="#" class="promo-image promo-overlay">
                        <img src="{{ asset('client/assets') }}/image/bg-images/promo-banner-with-text.jpg" alt="">
                    </a>
                </div>
                <div class="col-lg-6 col-md-6 mb--30">
                    <a href="#" class="promo-image promo-overlay">
                        <img src="{{ asset('client/assets') }}/image/bg-images/promo-banner-with-text-2.jpg" alt="">
                    </a>
                </div>
            </div>
        </div>
                        ...
                        <div class="product-slider multiple-row  slider-border-multiple-row  sb-slick-slider"
                            ...
                            <div class="single-slide">
                                <div class="product-card">
                                    ...
                                    <div class="product-card--body">
                                        <div class="card-image">
                                            <img src="{{ asset('client/assets') }}/image/products/product-12.jpg"
                                                alt="">
                                            <div class="hover-contents">
                                                <a href="product-details.html" class="hover-image">
                                                    <img src="{{ asset('client/assets') }}/image/products/product-11.jpg"
            ...
            <div class="product-slider with-countdown  slider-border-single-row sb-slick-slider"
                ...
                <div class="single-slide">
                    <div class="product-card">
                        ...
                        <div class="product-card--body">
                            <div class="card-image">
                                <img src="{{ asset('client/assets') }}/image/products/product-13.jpg" alt="">
                                <div class="hover-contents">
                                    <a href="product-details.html" class="hover-image">
                                        <img src="{{ asset('client/assets') }}/image/products/product-11.jpg"
                                            alt="">
    ...
    <section class="section-margin bg-image section-padding-top section-padding"
        data-bg="{{ asset('client/assets') }}/image/bg-images/best-seller-bg.jpg">
        <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5 col-md-6">
                        <div class="author-image">
                            <img src="{{ asset('client/assets') }}/image/others/best-seller-author.jpg" alt="">
                        </div>
                    </div>
            ...
            <div class="row space-db--30">
                <div class="col-lg-8 mb--30">
                    <div class="promo-wrapper promo-type-one">
                        <a href="#" class="promo-image  promo-overlay bg-image"
                            data-bg="{{ asset('client/assets') }}/image/bg-images/promo-banner-mid.jpg">
                            <!-- <img src="{{ asset('client/assets') }}/image/bg-images/promo-banner-mid.jpg" alt=""> -->
                        </a>
                ...
                <div class="col-lg-4 mb--30">
                    <div class="promo-wrapper promo-type-two ">
                        <a href="#" class="promo-image promo-overlay bg-image"
                            data-bg="{{ asset('client/assets') }}/image/bg-images/promo-banner-small.jpg">
                            <!-- <img src="{{ asset('client/assets') }}/image/bg-images/promo-banner-small.jpg" alt=""> -->
                        </a>
                        <div class="promo-text">
                            <div class="promo-text-inner">
    ...
    <section class="section-margin">
        <div class="promo-wrapper promo-type-three">
            <a href="#" class="promo-image promo-overlay bg-image"
                data-bg="{{ asset('client/assets') }}/image/bg-images/promo-banner-full.jpg">
            </a>
        ...
        <div class="container">
            ...
            <div class="blog-slider sb-slick-slider"
                ...
                <div class="single-slide">
                    <div class="blog-card">
                        <div class="image">
                            <img src="{{ asset('client/assets') }}/image/others/blog-grid-1.jpg" alt="">
                        </div>
                        <div class="content">
                            ...
                            <p class="meta-para"><i class="fas fa-user-edit"></i>Post by <a href="#">Hastech</a>
                            </p>
                ...
                <div class="single-slide">
                    <div class="blog-card">
                        <div class="image">
                            <img src="{{ asset('client/assets') }}/image/others/blog-grid-2.jpg" alt="">
                        </div>
                        <div class="content">
                            <div class="content-header">
                                <div class="date-badge">
                ...
                <div class="single-slide">
                    <div class="blog-card">
                        <div class="image">
                            <img src="{{ asset('client/assets') }}/image/others/blog-grid-3.jpg" alt="">
                        </div>
                        <div class="content">
                            <div class="content-header">
                                <div class="date-badge">
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            ...
                            <div class="product-details-slider sb-slick-slider arrow-type-two"
                                ...
                                <div class="single-slide">
                                    <img src="{{ asset('client/assets') }}/image/products/product-details-1.jpg"
                                        alt="">
                                </div>
                                <div class="single-slide">
                                    <img src="{{ asset('client/assets') }}/image/products/product-details-2.jpg"
                                        alt="">
                                </div>
                                <div class="single-slide">
                                    <img src="{{ asset('client/assets') }}/image/products/product-details-3.jpg"
                                        alt="">
                                </div>
                                <div class="single-slide">
                                    <img src="{{ asset('client/assets') }}/image/products/product-details-4.jpg"
                                        alt="">
                                </div>
                                <div class="single-slide">
                                    <img src="{{ asset('client/assets') }}/image/products/product-details-5.jpg"
                                        alt="">
                                </div>
                            </div>
