                        ...
                        <div class="card-body">
                            ...
                            <form class="" method="POST" action="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" value="" placeholder="Nhập tên danh mục">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="slug" id="slug" value="" placeholder="Slug">
                                </div>
