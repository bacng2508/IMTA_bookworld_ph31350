                            ...
                            <div class="mb-3 d-flex justify-content-between ">
                                <form action="" method="GET" class="d-flex">
                                    <div class="form-group mb-0 mr-1">
                                        <input type="text" class="form-control" value="" name="q" placeholder="Tên danh mục tìm kiếm" style="width: 280px;">
                                    </div>
                            ...
                            <table id="example2" class="table table-bordered table-hover mb-3">
                                ...
                                <tbody class="text-center">
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle;">Phiêu lưu</td>
                                            <td class="text-center" style="vertical-align: middle;">
                                                <div class="d-flex justify-content-center">
                                                    <a href="" class="btn btn-warning mr-1">Sửa</a>
